...
def get_lumel_time(lumel_connection):
    response = lumel_connection.send_command(lumel_connection.form_command(1,3,4045,1))
    return str(lumel_connection.extrac_register_data_from_response(response,1,'int')[0])
